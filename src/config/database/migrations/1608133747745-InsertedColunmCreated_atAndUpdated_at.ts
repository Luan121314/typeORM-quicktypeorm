...
export class InsertedColunmCreatedAtAndUpdatedAt1608133747745 implements MigrationInterface {
    name = 'InsertedColunmCreatedAtAndUpdatedAt1608133747745'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `content` DROP FOREIGN KEY `FK_0b349f6b8ca7f05eed39ffb956d`");
        await queryRunner.query("ALTER TABLE `content` CHANGE `created_at` `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `content` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        ...
        await queryRunner.query("ALTER TABLE `lesson` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `lesson` CHANGE `classeId` `classeId` varchar(36) NULL");
        await queryRunner.query("ALTER TABLE `class` CHANGE `created_at` `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `class` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `student` CHANGE `created_at` `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `student` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
